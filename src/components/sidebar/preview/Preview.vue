<template>
    <div class="column is-1 mr-3 mb-3 width-456 sidebar-no-pager border-solid">
            ...
            <div class="column is-24 py-0">
                <div class="content">
                    ...
                    <span
                        ...
                        {{ ('Bitte überprüfen Sie gründlich das Dokument, insbesondere auf Rechtschreibfehler.') }}
                    </span>
                </div>
            </div>
