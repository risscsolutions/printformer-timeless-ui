<template>
    <agile v-show="previewPages.length > 0" ref="carousel" class="thumbnails" :slidesToShow="4" :dots="false" :infinite="false">
        <div v-for="(page, index) in previewPages" class="slide slide--thumbniail" :key="index" :class="'slide--' + index">
            <img :style="{'border': currentPage === page.pageNumber ? 'black 5px solid': 'transparent 5px solid'}"
